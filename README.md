...
1. **Modeling PL/SQL with UML classes**, from which **specifications** can be generated, and from which **scafolding-code can be generated**.

1. The perfect transfer of documentation (descriptions) from the model to the code.

1. Improved development process by using model generated code.
...
<a  href="https://rawcdn.githack.com/sco2012/model-plsql-code-with-uml/0ae0a107caf5c986048b9beb42d0d08f0314a4db/html/index.html" target="_blank">
  Open link2
</a>
